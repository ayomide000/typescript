...
let bands: string[] = [] // while this is strictly a string array type and cannot accept any other data type
...
let myTuple: [string, number, boolean] = ['Dave', 52, true] // more strict than an array
...
interface Guitarist {
    name?: string,
    active: boolean, // to make the type optional, you add (?) to it 
